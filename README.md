...
- riproduzione continua di file MP3, WAV, AAC/M4A, WMA e AIFF con decodifica e resampling automatici;
...
- backend HackRF: frequenza 1–6000 MHz, sample rate IQ 2,4 MHz centrato sulla frequenza trasmessa, deviazione FM ±75 kHz, guadagno TX 0–47 dB e amplificatore RF;
- modalità solo portante per misurare separatamente rumore e spurie RF senza pilot, RDS o modulazione audio;
...
Il backend HackRF è operativo e le librerie native sono incluse. Il driver WinUSB del dispositivo rimane un requisito hardware inevitabile. Prima di trasmettere verificare sempre carico fittizio, frequenza, autorizzazioni e guadagno.
